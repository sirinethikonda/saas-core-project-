  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        ...
        await apiClient.post(`/tenants/${tenantId}/users`, form);
      }
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md rounded-[32px] p-8 shadow-2xl animate-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading}
            className="w-full bg-primary text-white p-4 rounded-2xl font-black flex justify-center shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all disabled:opacity-50"
          >
